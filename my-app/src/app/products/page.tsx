...
export default async function ProductsPage({ searchParams }: ProductsPageProps) {
  ...
  if (products.length === 0) {
    products = [
      ...
      { id: "f5", title: "Celestial Glass Pendant", price: 19500, images: ["https://images.unsplash.com/photo-1543198126-a8ad8e47fb21?q=80&w=1200"], stock: 8, category: { name: "Abstract Edge" }, reviews: [], createdAt: new Date() },
      { id: "f6", title: "Minimalist Stoneware Plate", price: 4500, images: ["https://images.unsplash.com/photo-1565193998248-d5a03e726549?q=80&w=1200"], stock: 24, category: { name: "The Minimalist" }, reviews: [], createdAt: new Date() },
    ];
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold mb-3 text-white">Seasonal Curations</h1>
              ...
              <div className="flex bg-[var(--surface-dark)] p-1 rounded-lg shrink-0">
                <button className="px-5 py-1.5 text-[11px] uppercase tracking-wider font-bold bg-[var(--background)] text-white rounded-md shadow-sm border border-white/5">Popular</button>
                <button className="px-5 py-1.5 text-[11px] uppercase tracking-wider font-bold text-muted hover:text-white transition-colors">Newest</button>
                <button className="px-5 py-1.5 text-[11px] uppercase tracking-wider font-bold text-muted hover:text-white transition-colors">Price</button>
              </div>
            </div>
            ...
            {products.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-20 text-center rounded-2xl bg-[var(--card-bg)] border border-[var(--card-border)]">
                ...
                <h3 className="text-lg font-bold mb-2 text-white">No pieces found</h3>
                        ...
                        <div className="h-full flex flex-col group-hover:-translate-y-1 transition-transform duration-300">
                          ...
                          <div className="px-1 flex-1 flex flex-col">
                            <div className="flex items-start justify-between gap-4 mb-1">
                              <h3 className="text-[15px] font-bold leading-snug text-white group-hover:text-primary transition-colors line-clamp-1">
                                {product.title}
                              </h3>
