      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl font-bold mb-3">New Creation</h1>
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              <div className="rounded-2xl border border-[var(--card-border)] bg-[var(--card-bg)] p-8">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h2 className="text-lg font-bold">Visual Portfolio</h2>
                </div>
            ...
            <div className="space-y-10">
              ...
              <div className="rounded-2xl border border-[var(--card-border)] bg-[var(--card-bg)] p-8">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h2 className="text-lg font-bold">Valuation</h2>
                </div>
