  ...
  return (
    <>
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">Complete Your Order</h1>
                  ...
                  {[
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className={`text-xs font-bold uppercase tracking-wider ${isActive ? 'text-[var(--foreground)]' : 'text-muted'}`}>{method.label}</span>
              ...
              <div className="sticky top-24 rounded-2xl border border-[var(--card-border)] bg-[var(--card-bg)] p-8 shadow-2xl shadow-black/20">
                ...
                <div className="space-y-4 border-t border-[var(--card-border)] pt-8 mb-8">
                  ...
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="font-bold">{formatCurrency(cartTotal * 0.05)}</span>
                  </div>
                  <div className="flex justify-between items-end pt-6 border-t border-[var(--card-border)]">
                    <span className="text-xs font-black uppercase tracking-widest text-muted">Total Amount</span>
